...
//Event_Skill 액티브 스킬 발동
	...
	//Monster Action Tag
	SIMPLERPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AI_Action_Death);
	SIMPLERPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AI_Action_Stagger);
	...
	SIMPLERPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Monster_Death);
	SIMPLERPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Monster_Stagger);
}
